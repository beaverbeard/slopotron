...
«Слопотрон» — скил для редакторов из семьи **[рИИдактор](https://redaktozavr.ru/rAIdactor?utm_source=rodion)**, рассылки про
...
Слопотрон идёт **предпоследним**: снимает AI-маркеры после смысловой и
нормативной правки и перед финальной типографикой — чтобы вычищенный текст
не переписывался заново.
## Лицензия
